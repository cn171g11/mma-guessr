...
const CHANGELOG = [
    {
        ...
        changes: [
            '🗺️ 地图开关重做：地图内新增 ✕ 关闭按钮，并把「🗺️ 地图」按钮从移动端专用扩展到 PC 端 —— 此前移动端存在地图展开后关不掉的问题（外部按钮被左下角计时器压住，且层级低于展开的地图）。',
            '🔧 修复移动端地图收不起来：地图开关按钮 z-index 由 1002 提升到 2000（高于展开态地图的 1500），并上移避开计时器区域，任何情况下都点得到。',
    ...
    },
    {
        ...
        changes: [
            ...
            '🔇 去掉底图加载提示：切换底图不再弹出「正在加载 / 加载完成」提示，改为静默切换，减少操作干扰。',
            '版本号递增至 v2.2.2。',
        ],
    },
    {
