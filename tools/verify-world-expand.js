...
const CANDIDATES = [
  ...
  { name: '法国巴黎·凯旋门', lat: 48.8738, lng: 2.2950, region: 'europe', difficulty: 1 },
  ...
  { name: '瑞士苏黎世·班霍夫大街', lat: 47.3744, lng: 8.5390, region: 'europe', difficulty: 2 },
  ...
  { name: '奥地利萨尔茨堡·老城', lat: 47.8007, lng: 13.0450, region: 'europe', difficulty: 3 },
  ...
  { name: '瑞典斯德哥尔摩·老城', lat: 59.3251, lng: 18.0710, region: 'europe', difficulty: 2 },
  { name: '挪威卑尔根·布吕根', lat: 60.3970, lng: 5.3232, region: 'europe', difficulty: 3 },
  ...
  { name: '希腊塞萨洛尼基·海滨大道', lat: 40.6260, lng: 22.9500, region: 'europe', difficulty: 3 },
  ...
  { name: '罗马尼亚布加勒斯特·老城', lat: 44.4310, lng: 26.0994, region: 'europe', difficulty: 4 },
  { name: '保加利亚索非亚·亚历山大涅夫斯基', lat: 42.6956, lng: 23.3340, region: 'europe', difficulty: 4 },
  { name: '匈牙利布达佩斯·渔人堡', lat: 47.5023, lng: 19.0346, region: 'europe', difficulty: 2 },
  { name: '斯洛文尼亚卢布尔雅那·龙桥', lat: 46.0516, lng: 14.5070, region: 'europe', difficulty: 3 },
  { name: '爱沙尼亚塔林·老城', lat: 59.4362, lng: 24.7463, region: 'europe', difficulty: 3 },
  { name: '拉脱维亚里加·老城', lat: 56.9470, lng: 24.1061, region: 'europe', difficulty: 4 },
  ...
  { name: '格鲁吉亚第比利斯·老城', lat: 41.6908, lng: 44.8090, region: 'europe', difficulty: 4 },
  ...
  { name: '日本福冈·运河城', lat: 33.5896, lng: 130.4010, region: 'asia', difficulty: 3 },
  ...
  { name: '韩国首尔·景福宫', lat: 37.5796, lng: 126.9770, region: 'asia', difficulty: 1 },
  ...
  { name: '马来西亚吉隆坡·双子塔', lat: 3.1578, lng: 101.7120, region: 'asia', difficulty: 1 },
  ...
  { name: '越南胡志明市·滨城市场', lat: 10.7727, lng: 106.6980, region: 'asia', difficulty: 2 },
  { name: '越南岘港·美溪海滩', lat: 16.0603, lng: 108.2400, region: 'asia', difficulty: 3 },
  { name: '柬埔寨暹粒·吴哥窟', lat: 13.4125, lng: 103.8670, region: 'asia', difficulty: 2 },
  { name: '缅甸仰光·大金塔', lat: 16.7983, lng: 96.1490, region: 'asia', difficulty: 3 },
  ...
  { name: '印度孟买·印度门', lat: 18.9220, lng: 72.8347, region: 'asia', difficulty: 2 },
  { name: '印度班加罗尔·库本公园', lat: 12.9762, lng: 77.5931, region: 'asia', difficulty: 4 },
  { name: '斯里兰卡科伦坡·加勒菲斯绿地', lat: 6.9271, lng: 79.8480, region: 'asia', difficulty: 3 },
  { name: '斯里兰卡康提·佛牙寺', lat: 7.2937, lng: 80.6413, region: 'asia', difficulty: 4 },
  { name: '孟加拉国达卡·国会大厦', lat: 23.7780, lng: 90.3700, region: 'asia', difficulty: 5 },
  { name: '阿联酋阿布扎比·大清真寺', lat: 24.4128, lng: 54.4748, region: 'asia', difficulty: 2 },
  { name: '卡塔尔多哈·伊斯兰艺术博物馆', lat: 25.2950, lng: 51.5390, region: 'asia', difficulty: 3 },
  ...
  { name: '阿塞拜疆巴库·火焰塔', lat: 40.3600, lng: 49.8240, region: 'asia', difficulty: 4 },
  ...
  { name: '美国迈阿密·南海滩', lat: 25.7790, lng: -80.1306, region: 'northamerica', difficulty: 2 },
  ...
  { name: '美国丹佛·联合车站', lat: 39.7530, lng: -105.0005, region: 'northamerica', difficulty: 3 },
  { name: '美国凤凰城·市中心', lat: 33.4484, lng: -112.0740, region: 'northamerica', difficulty: 3 },
  { name: '美国拉斯维加斯·长街', lat: 36.1126, lng: -115.1747, region: 'northamerica', difficulty: 2 },
  { name: '美国圣地亚哥·煤气灯街区', lat: 32.7101, lng: -117.1620, region: 'northamerica', difficulty: 3 },
  { name: '美国新奥尔良·法国区', lat: 29.9584, lng: -90.0641, region: 'northamerica', difficulty: 3 },
  { name: '美国纳什维尔·百老汇大街', lat: 36.1622, lng: -86.7780, region: 'northamerica', difficulty: 3 },
  { name: '美国奥斯汀·第六街', lat: 30.2672, lng: -97.7431, region: 'northamerica', difficulty: 3 },
  { name: '美国费城·独立宫', lat: 39.9489, lng: -75.1500, region: 'northamerica', difficulty: 2 },
  { name: '美国盐湖城·圣殿广场', lat: 40.7705, lng: -111.8919, region: 'northamerica', difficulty: 3 },
  { name: '美国明尼阿波利斯·市中心', lat: 44.9778, lng: -93.2650, region: 'northamerica', difficulty: 3 },
  ...
  { name: '加拿大渥太华·国会山', lat: 45.4235, lng: -75.7010, region: 'northamerica', difficulty: 2 },
  ...
  { name: '墨西哥瓜达拉哈拉·大教堂', lat: 20.6769, lng: -103.3470, region: 'northamerica', difficulty: 3 },
  { name: '墨西哥蒙特雷·马可广场', lat: 25.6690, lng: -100.3095, region: 'northamerica', difficulty: 4 },
  ...
  { name: '巴拿马巴拿马城·旧城区', lat: 8.9520, lng: -79.5354, region: 'northamerica', difficulty: 4 },
  ...
  { name: '巴西萨尔瓦多·佩洛里尼奥', lat: -12.9728, lng: -38.5100, region: 'southamerica', difficulty: 3 },
  ...
  { name: '乌拉圭蒙得维的亚·独立广场', lat: -34.9068, lng: -56.2000, region: 'southamerica', difficulty: 3 },
  { name: '巴拉圭亚松森·帕尔马街', lat: -25.2812, lng: -57.6350, region: 'southamerica', difficulty: 4 },
  { name: '玻利维亚拉巴斯·穆里略广场', lat: -16.4961, lng: -68.1340, region: 'southamerica', difficulty: 4 },
  { name: '玻利维亚圣克鲁斯·市中心', lat: -17.7836, lng: -63.1823, region: 'southamerica', difficulty: 4 },
  { name: '厄瓜多尔瓜亚基尔·圣安娜山', lat: -2.1950, lng: -79.8860, region: 'southamerica', difficulty: 4 },
  ...
  { name: '阿尔及利亚阿尔及尔·卡斯巴', lat: 36.7844, lng: 3.0600, region: 'africa', difficulty: 5 },
  { name: '尼日利亚阿布贾·千年塔', lat: 9.0620, lng: 7.4891, region: 'africa', difficulty: 5 },
  ...
  { name: '坦桑尼亚达累斯萨拉姆·独立广场', lat: -6.8170, lng: 39.2819, region: 'africa', difficulty: 4 },
  ...
  { name: '南非约翰内斯堡·宪法山', lat: -26.1890, lng: 28.0450, region: 'africa', difficulty: 3 },
  { name: '南非比勒陀利亚·联合大厦', lat: -25.7406, lng: 28.2110, region: 'africa', difficulty: 3 },
  ...
  { name: '澳大利亚珀斯·国王公园', lat: -31.9590, lng: 115.8368, region: 'oceania', difficulty: 3 },
  ...
  { name: '澳大利亚黄金海岸·冲浪者天堂', lat: -28.0017, lng: 153.4310, region: 'oceania', difficulty: 3 },
  { name: '澳大利亚阿德莱德·维多利亚广场', lat: -34.9287, lng: 138.6008, region: 'oceania', difficulty: 3 },
  { name: '新西兰奥克兰·天空塔', lat: -36.8485, lng: 174.7620, region: 'oceania', difficulty: 2 },
  ...
  { name: '新西兰罗托鲁瓦·政府花园', lat: -38.1380, lng: 176.2508, region: 'oceania', difficulty: 4 },
  { name: '新西兰尼尔森·市中心', lat: -41.2706, lng: 173.2840, region: 'oceania', difficulty: 5 },
  ...
  { name: '新喀里多尼亚努美阿·海滨大道', lat: -22.2758, lng: 166.4580, region: 'oceania', difficulty: 5 },
  { name: '塔希提帕皮提·海滨', lat: -17.5350, lng: -149.5695, region: 'oceania', difficulty: 5 },
...
async function main() {
  ...
  for (const { cand, result } of results) {
    if (result.valid) valid.push({ ...cand, imageId: result.imageId, actualLat: result.lat, actualLng: result.lng });
    else invalid.push(cand);
  }

  console.log(`验证完成: 有效 ${valid.length} / 无效 ${invalid.length}`);
  console.log(`按大洲统计: ${JSON.stringify(valid.reduce((a, c) => { a[c.region] = (a[c.region]||0)+1; return a; }, {}))}`);
